...
mainWindow.columnconfigure(2, weight=300)
mainWindow.columnconfigure(3, weight=60)
...
# below line 2 show default value of radio button among 3 radio buttons
rbValue.set(2)
# Radio buttons
...
yearSpin = tkinter.Spinbox(dateFrame, width=5, from_=2000, to=2025)
